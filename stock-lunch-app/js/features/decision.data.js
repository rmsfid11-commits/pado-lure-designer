...
const RAW_DECISION_MENUS = [
  ...
  { menu: "제육볶음", emoji: "🥘", solo: true, group: true, maxTime: 20, price: 9000 },
  { menu: "된장찌개", emoji: "🍲", solo: true, group: true, maxTime: 20, price: 8000 },
  ...
  { menu: "수육백반", emoji: "🍚", solo: true, group: true, maxTime: 20, price: 10000 },
  { menu: "고등어구이백반", emoji: "🐟", solo: true, group: true, maxTime: 20, price: 9000 },
  { menu: "갈치조림", emoji: "🐟", solo: true, group: true, maxTime: 20, price: 12000 },
  { menu: "코다리조림", emoji: "🐟", solo: true, group: true, maxTime: 20, price: 10000 },
  { menu: "계란말이백반", emoji: "🍳", solo: true, group: true, maxTime: 15, price: 8000 },
  { menu: "두루치기", emoji: "🥘", solo: true, group: true, maxTime: 25, price: 10000 },
  { menu: "순두부찌개", emoji: "🍲", solo: true, group: true, maxTime: 15, price: 8000 },
  { menu: "동태찌개", emoji: "🍲", solo: true, group: true, maxTime: 20, price: 9000 },
  { menu: "곤드레밥", emoji: "🍚", solo: true, group: true, maxTime: 15, price: 9000 },
  { menu: "낙지비빔밥", emoji: "🐙", solo: true, group: true, maxTime: 20, price: 11000 },
  { menu: "오징어볶음", emoji: "🦑", solo: true, group: true, maxTime: 20, price: 10000 },
  { menu: "불고기", emoji: "🥩", solo: false, group: true, maxTime: 30, price: 13000 },
  { menu: "제육쌈밥", emoji: "🥬", solo: true, group: true, maxTime: 20, price: 10000 },
  { menu: "두부김치", emoji: "🥘", solo: true, group: true, maxTime: 15, price: 9000 },
  { menu: "감자탕", emoji: "🍲", solo: false, group: true, maxTime: 30, price: 11000 },
  { menu: "소불고기덮밥", emoji: "🍚", solo: true, group: true, maxTime: 15, price: 9000 },
  { menu: "삼계탕", emoji: "🍗", solo: true, group: true, maxTime: 30, price: 16000 },
  { menu: "추어탕", emoji: "🍲", solo: true, group: true, maxTime: 20, price: 10000 },
  { menu: "알탕", emoji: "🍲", solo: false, group: true, maxTime: 25, price: 12000 },
  { menu: "매운탕", emoji: "🍲", solo: false, group: true, maxTime: 25, price: 13000 },
  { menu: "설렁탕", emoji: "🍚", solo: true, group: true, maxTime: 20, price: 9000 },
  { menu: "곰탕", emoji: "🍚", solo: true, group: true, maxTime: 20, price: 10000 },
  { menu: "뼈해장국", emoji: "🍲", solo: true, group: true, maxTime: 20, price: 9000 },
  { menu: "낙지덮밥", emoji: "🐙", solo: true, group: true, maxTime: 20, price: 11000 },
  { menu: "오징어덮밥", emoji: "🦑", solo: true, group: true, maxTime: 20, price: 9000 },
  { menu: "스팸김치볶음밥", emoji: "🍳", solo: true, group: true, maxTime: 15, price: 8000 },
  { menu: "김치볶음밥", emoji: "🍳", solo: true, group: true, maxTime: 15, price: 7000 },
  { menu: "모듬순대", emoji: "🌭", solo: true, group: true, maxTime: 15, price: 9000 },
  { menu: "만두국", emoji: "🥟", solo: true, group: true, maxTime: 15, price: 7000 },
  { menu: "콩나물국밥", emoji: "🍚", solo: true, group: true, maxTime: 15, price: 7000 },
];
