...
const RAW_DECISION_MENUS = [
  ...
  { menu: "짜장밥", emoji: "🥡", solo: true, group: true, maxTime: 15, price: 7000, cuisine: "중식" },
  { menu: "삼선짬뽕", emoji: "🍜", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "중식" },
  { menu: "우육탕면", emoji: "🍜", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "중식" },
  { menu: "유산슬덮밥", emoji: "🥘", solo: true, group: true, maxTime: 15, price: 10000, cuisine: "중식" },
  { menu: "팔보채덮밥", emoji: "🥘", solo: true, group: true, maxTime: 15, price: 10000, cuisine: "중식" },
  { menu: "새우볶음밥", emoji: "🍤", solo: true, group: true, maxTime: 15, price: 8000, cuisine: "중식" },
  { menu: "잡탕밥", emoji: "🍲", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "중식" },
  { menu: "동파육덮밥", emoji: "🍖", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "중식" },
  { menu: "마라샹궈", emoji: "🌶️", solo: true, group: true, maxTime: 20, price: 12000, cuisine: "중식" },
  { menu: "짬뽕밥", emoji: "🍚", solo: true, group: true, maxTime: 15, price: 8000, cuisine: "중식" },
  ...
  { menu: "냉모밀", emoji: "🍜", solo: true, group: true, maxTime: 15, price: 8000, cuisine: "일식" },
  { menu: "오므라이스", emoji: "🍳", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "일식" },
  { menu: "사케동", emoji: "🐟", solo: true, group: true, maxTime: 15, price: 11000, cuisine: "일식" },
  { menu: "나베우동", emoji: "🍲", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "일식" },
  { menu: "미소라멘", emoji: "🍜", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "일식" },
  { menu: "츠케멘", emoji: "🍜", solo: true, group: true, maxTime: 15, price: 10000, cuisine: "일식" },
  { menu: "유부초밥", emoji: "🍙", solo: true, group: true, maxTime: 10, price: 6000, cuisine: "일식" },
  { menu: "규카츠", emoji: "🥩", solo: true, group: true, maxTime: 20, price: 12000, cuisine: "일식" },
  { menu: "타마고동", emoji: "🍳", solo: true, group: true, maxTime: 15, price: 7000, cuisine: "일식" },
  ...
  { menu: "스테이크", emoji: "🥩", solo: false, group: true, maxTime: 30, price: 20000, cuisine: "양식" },
  { menu: "피자", emoji: "🍕", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "양식" },
  { menu: "오믈렛", emoji: "🍳", solo: true, group: true, maxTime: 15, price: 8000, cuisine: "양식" },
  { menu: "크림파스타", emoji: "🍝", solo: true, group: true, maxTime: 20, price: 12000, cuisine: "양식" },
  { menu: "토마토파스타", emoji: "🍝", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "양식" },
  { menu: "라자냐", emoji: "🧀", solo: true, group: true, maxTime: 20, price: 12000, cuisine: "양식" },
  { menu: "필라프", emoji: "🍚", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "양식" },
  { menu: "치킨스테이크", emoji: "🍗", solo: true, group: true, maxTime: 20, price: 13000, cuisine: "양식" },
  { menu: "베이글샌드위치", emoji: "🥯", solo: true, group: false, maxTime: 10, price: 7000, cuisine: "양식" },
  { menu: "그릴드치킨샐러드", emoji: "🥗", solo: true, group: false, maxTime: 10, price: 10000, cuisine: "양식" },
  { menu: "에그베네딕트", emoji: "🍳", solo: true, group: true, maxTime: 20, price: 12000, cuisine: "양식" },
  { menu: "클럽샌드위치", emoji: "🥪", solo: true, group: false, maxTime: 10, price: 8000, cuisine: "양식" },
  ...
  { menu: "그린커리", emoji: "🍛", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "아시안" },
  { menu: "똠얌꿍", emoji: "🍲", solo: true, group: true, maxTime: 20, price: 12000, cuisine: "아시안" },
  { menu: "팟씨유", emoji: "🍜", solo: true, group: true, maxTime: 20, price: 10000, cuisine: "아시안" },
  { menu: "카오팟", emoji: "🍛", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "아시안" },
  { menu: "월남쌈", emoji: "🥬", solo: true, group: true, maxTime: 25, price: 12000, cuisine: "아시안" },
  { menu: "버터치킨커리", emoji: "🍛", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "아시안" },
  { menu: "탄두리치킨", emoji: "🍗", solo: true, group: true, maxTime: 20, price: 12000, cuisine: "아시안" },
  { menu: "난세트", emoji: "🫓", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "아시안" },
  { menu: "사테", emoji: "🍢", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "아시안" },
  { menu: "미고랭", emoji: "🍝", solo: true, group: true, maxTime: 15, price: 9000, cuisine: "아시안" },
  { menu: "락사", emoji: "🍜", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "아시안" },
  { menu: "콤보플레이트", emoji: "🍱", solo: true, group: true, maxTime: 20, price: 13000, cuisine: "아시안" },
  { menu: "새우볶음쌀국수", emoji: "🍜", solo: true, group: true, maxTime: 20, price: 11000, cuisine: "아시안" },
  { menu: "태국식볶음면", emoji: "🍝", solo: true, group: true, maxTime: 20, price: 10000, cuisine: "아시안" },
];
